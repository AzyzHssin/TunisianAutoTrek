...
const DisplayModelsDetails = (props) => {
  return (
    <>
     <div className="overflow-hidden transition-shadow duration-300 bg-white rounded border shadow-sm" data-aos="zoom-in">
          <img src={props.car.carIMG}
          ...
          <div className="p-5">
            ...
            <a href="#_" className="relative tracking-wide inline-flex items-center justify-start py-2 pl-4 pr-12 overflow-hidden font-normal text-white transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-black group">
...
<span className="relative w-full text-left transition-colors duration-200 ease-in-out group-hover:text-white">More Details</span>
</a>
          </div>
        </div>
    </>
