...
<Search />
            ...
            <a href="#" className="hover:text-gray-800 dark:hover:text-white mx-1.5 sm:mx-3 ">
...
<div className="flex items-center space-x-4">
  ...
  <li className=""><a className="bg-gray-200 hover:bg-yellow-400 py-2 px-4 block whitespace-no-wrap" href="#">Admin Dashboard</a></li>
    <li className=""><a onClick={handleSignOut} className="rounded-b bg-gray-200 hover:bg-yellow-400 py-2 px-4 block whitespace-no-wrap" href="#">&#9658; Logout</a></li>
  </ul>
</div>
  ...
  <Link to="/signin">
                  <li>
                    <a
                      aria-label="Sign in"
                      title="Sign in"
                      className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-normal text-white transition duration-200  hover:bg-yellow-500 hover:text-black focus:shadow-outline focus:outline-none">
